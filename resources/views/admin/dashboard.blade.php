...
@section('content')
    <div class="flex-grid">
        <a href="{{ url('admin/checkin') }}" id="checkInBtn" class="btn btn-success active">Check in</a>
        <a href="{{ url('admin/checkout') }}" id="checkOutBtn" class="btn btn-danger active">Check out</a>
        <a href="{{ url('admin/bookings') }}" id="bookingsBtn" class="btn btn-info active">Bookings</a>
        <a href="{{ route('guests.create') }}" id="newBookingBtn" class="btn btn-secondary active">New Booking</a>
    </div>
