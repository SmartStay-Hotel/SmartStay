...
@section('content')
    <div class="row">
        <div class="col-sm-10" id="groupDashBtn">
            <a href="checkinform" id="checkInBtn" class="btn btn-success">Check in</a>
            <a href="payments" id="checkOutBtn" class="btn btn-danger">Check out</a>
            <a href="#" id="bookingsBtn" class="btn btn-info">Bookings</a>
            <a href="#" id="newBookingBtn" class="btn btn-secondary">New Booking</a>
        </div>
    </div>
            ...
            <div class="card text-center">
                ...
                <div class="card-body" id="pendingOrdersBody">
                    ...
                    <ul class="card-text" id="dispatchedOrdersList">
                        <li><span>Alarm</span> - Happy Giraffe - <span>311</span><button style="float:right"><i class="fas fa-check"></i></button></li>
                        <li><span>Pet care</span> - Crazy Elephant - <span>209</span><button style="float:right"><i class="fas fa-check"></i></button></li>
                        <li><span>Restaurant</span> - Aggressive Hippo - <span>207</span><button style="float:right"><i class="fas fa-check"></i></button></li>
                        <li><span>Restaurant</span> - Lunatic Racoon - <span>105</span><button style="float:right"><i class="fas fa-check"></i></button></li>
                    </ul>
                </div>
            </div>
        </div>
