...
@section('breadcrumb')
    <nav aria-label="breadcrumb" style="background-color: #F5F5F5; flex: 8;">
        <ol class="breadcrumb" style="background-color: #F5F5F5">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin') }}">Housekeeping</a></li>
        </ol>
...
@section('content')
    ...
    <div class="col-sm-9 table-responsive" id="alarmTableContainer">
        ...
        <table class="table table-sm table-hover text-center" id="alarmTable">
            ...
            <tr><h2 id="alarmTitle"><i class="fas fa-broom fa-sm" style="padding: 5px;"></i>Housekeeping<a href="#"><i id="addGuest" class="fas fa-user-plus fa-xs" style="padding-left: 70%; color: white; z-index: 1;"></i></a></h2></tr>
            <tr>
